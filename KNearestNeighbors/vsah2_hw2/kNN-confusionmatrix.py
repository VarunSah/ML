...
def plot_confusion_matrix(cm, classes, k,
    ...
    if normalize:
        ...
        print('Confusion Matrix: Yeast Dataset kNN Classifier with k = ' + str(k))
    ...
    plt.savefig("VarunSah_HW2_Part3_k=" + str(k) + ".jpg")
...
#             print 'Predicted class : ' + predicted_class + '\tActual class : ' + actual_class
        ...
        confusion_matrix_k = confusion_matrix(test_data['class'], test_predictions, labels=output_arff_order)
        print confusion_matrix_k
        # Compute confusion matrix
        
        # Plot non-normalized confusion matrix
        plt.figure()
        plot_confusion_matrix(confusion_matrix_k, classes=output_arff_order, k = k,
                              title='Confusion Matrix: Yeast Dataset kNN Classifier with k = ' + str(k))
