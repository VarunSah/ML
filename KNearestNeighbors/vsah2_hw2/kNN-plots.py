...
#                 print 'Predicted class : ' + predicted_class + '\tActual class : ' + actual_class
        ...
        print dict(zip(k_list, accuracy_list))
            
        pylab.figure("Figure: Plot of Test-set Accuracy as a function of k")
        pylab.plot(k_list, accuracy_list, 'bx')
        pylab.plot(k_list, accuracy_list, 'b')
        pylab.title("Plot of Test-set Accuracy as a function of k")
        pylab.ylabel("Accuracy on Test-set")
        pylab.xlabel("k")
        pylab.savefig("VarunSah_Homework1_Part2_yeast" + ".jpg") 
...
#                 print 'Predicted value : ' + "{0:.6f}".format(predicted_response) + '\tActual value : ' + "{0:.6f}".format(actual_response)
            ...
            print k + mean_error
        print dict(zip(k_list, mean_error_list))
        
        print dict(zip(k_list, mean_error_list))    
        pylab.figure("Figure: Plot of Test-set Mean Absolute Error as a function of k")
        pylab.plot(k_list, mean_error_list, 'bx')
        pylab.plot(k_list, mean_error_list, 'b')
        pylab.title("Plot of Test-set Mean Absolute Error as a function of k")
        pylab.ylabel("Test-set Mean Absolute Error")
        pylab.xlabel("k")
        pylab.savefig("VarunSah_Homework1_Part2_wine" +".jpg") 
#             print 'Mean absolute error : ' + "{0:.16f}".format(mean_error) + '\nTotal number of instances : ' + str(number_of_test_instances)
